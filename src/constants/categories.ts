...
export const CATEGORIES: CategoryMeta[] = [
  ...
  },
  {
    ...
    icon: 'waves',
    iconFamily: 'MaterialCommunityIcons',
    description: 'Flooding, water rising, or flash flood',
    accessibilityLabel: 'Report flooding in the area',
  },
  {
    key: 'injured_animal',
    ...
    icon: 'paw',
    iconFamily: 'MaterialCommunityIcons',
    description: 'Injured, trapped, or sick animal needing help',
    accessibilityLabel: 'Report an injured animal',
  },
  {
    key: 'building_risk',
    label: 'Building Risk',
    ...
    iconFamily: 'MaterialCommunityIcons',
    description: 'Building at risk of collapse or structural damage',
    accessibilityLabel: 'Report a building at risk',
  },
  {
    key: 'other',
    label: 'Other',
